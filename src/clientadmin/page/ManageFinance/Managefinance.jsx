                                                        ...
                                                        financeDetails.map((finance, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td style={{ color: finance.status ? 'green' : 'red' }}>
                                                                    {finance.status ? 'Active' : 'Inactive'}
                                                                </td>
                                                                <td>
                                                                    <button
                                                                        type="button"
                                                                    ...
                                                                    <button
                                                                        type="button"
                                                                        className={`btn btn-outline-${finance.status ? 'danger' : 'success'} btn-icon-text`}
                                                                        onClick={() => handleDeactivate(finance)}
                                                                    >
                                                                        <i className={`mdi mdi-${finance.status ? 'delete' : 'check'} btn-icon-prepend`}></i> {finance.status ? 'Deactivate' : 'Activate'}
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        ))
